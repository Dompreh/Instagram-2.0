...
function Modal() {
  ...
  const uploadPost= async () =>{
    ...
    //2)Get the post ID the newly created post
    //3)Upload the image to firebase storage storage with the post ID
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          {/* This tricks the browser into centering the modal contents */}
          <span
              ...
              <div>
                {selectedFile ? (
                  ...
                  className=" mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 cursor-pointer">
                   <CameraIcon className='h-4 w-6 text-red-600 ' aria-hidden='true'/>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <input  className="border-none focus:ring-0 w-full text-center" type='text' ref={captionRef} placeholder="Enter a caption..."/>
                  </div>
